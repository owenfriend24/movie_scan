...
def main(data_dir, file_type, sub, out_dir, first_mov, skip_second):
    ...
    if file_type == 'surprise' or file_type == 'all':
        if skip_second:
            if first_mov == 'coin':
                run_com(f"cp /home1/09123/ofriend/analysis/movie_scan/coin_events.txt {func_dir}/sub-{sub}_task-movie_run-01_events.tsv")
            else:
                run_com(f"cp /home1/09123/ofriend/analysis/movie_scan/jinx_events.txt {func_dir}/sub-{sub}_task-movie_run-01_events.tsv")
        else:
            if first_mov == 'coin':
                run_com(f"cp /home1/09123/ofriend/analysis/movie_scan/coin_events.txt {func_dir}/sub-{sub}_task-movie_run-01_events.tsv")
                run_com(f"cp /home1/09123/ofriend/analysis/movie_scan/jinx_events.txt {func_dir}/sub-{sub}_task-movie_run-02_events.tsv")
            else:
                run_com(f"cp /home1/09123/ofriend/analysis/movie_scan/jinx_events.txt {func_dir}/sub-{sub}_task-movie_run-01_events.tsv")
                run_com(f"cp /home1/09123/ofriend/analysis/movie_scan/coin_events.txt {func_dir}/sub-{sub}_task-movie_run-02_events.tsv")
